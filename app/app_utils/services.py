...
def get_memory_service():
    """Process-wide memory service pointing at Vertex AI Memory Bank."""
    ...
    agent_engine_id = os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID") or os.environ.get(
        "MEMORY_BANK_ID", "7572533942830497792"
    )
    if agent_engine_id:
        from google.adk.memory import VertexAiMemoryBankService

        return VertexAiMemoryBankService(
            project=os.environ.get("GOOGLE_CLOUD_PROJECT", "qwiklabs-gcp-03-f53b15124fc6"),
            location=os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_LOCATION")
