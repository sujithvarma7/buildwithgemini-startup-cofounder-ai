...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    # Runner for the A2A path, sharing the same session/artifact/memory services
    # as the adk_api and reasoning_engine paths (see services.py).
...
app.title = "startup-cofounder-ai"
app.description = "API for interacting with Startup Co-Founder AI"
